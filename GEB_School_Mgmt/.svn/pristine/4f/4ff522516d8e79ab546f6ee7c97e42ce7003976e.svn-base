<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrustHome.aspx.cs" MasterPageFile="~/Master/TrustMain.Master" Inherits="GEB_School.Client.UI.TrustHome" %>
    ...
    <div id="divMain" style="width: 100%; padding-top: 5px;">
        ...
        <div runat="server" id="CollegeDashboard" class="water-img" width="100%" style="text-align:center;">
           <%-- <asp:Image class="watermark" ID="logowaterimg" runat="server" Width="500px" Height="400px"
            ...
            <asp:Image ImageUrl="~/Images/GEB LOGO school logo in english.jpg" CssClass="watermark" runat="server" ID="imgphoto"
