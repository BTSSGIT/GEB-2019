<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="UpgradeStudent.aspx.cs" Inherits="GEB_School.Client.UI.UpgradeStudent" %>
