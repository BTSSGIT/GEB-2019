...
namespace GEB_School.BO
{
    public class EmployeeattendanceBo
    {
        ...
        public const string EMPLOYEEATTENDANCE_EMPLOYEEATTANDENCEMID = "EmployeeAttandenceMID";
        ...
        private int intEmployeeAttandenceMID = 0;
        ...
        #region ---Properties---
        public int EmployeeAttandenceMID
        {
            get { return intEmployeeAttandenceMID; }
            set { intEmployeeAttandenceMID = value; }
        }
        public int TrustMID
        {
