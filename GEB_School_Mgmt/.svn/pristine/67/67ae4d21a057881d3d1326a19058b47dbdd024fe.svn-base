	...
	public class JournalVoucherMBL 
	{
        ...
        public ApplicationResult JournalVoucherM_Insert(JournalVoucherMBO objJournalVoucherMBO)
        {
            try
            {
                ...
                pSqlParameter[2].Direction = ParameterDirection.Input;
                pSqlParameter[2].Value = objJournalVoucherMBO.LedgerID;

                pSqlParameter[3] = new SqlParameter("@VoucherNo", SqlDbType.Int);
                pSqlParameter[3].Direction = ParameterDirection.Input;
                pSqlParameter[3].Value = objJournalVoucherMBO.VoucherNo;

                pSqlParameter[4] = new SqlParameter("@VoucherCode", SqlDbType.NVarChar);
                pSqlParameter[4].Direction = ParameterDirection.Input;
                pSqlParameter[4].Value = objJournalVoucherMBO.VoucherCode;

                pSqlParameter[5] = new SqlParameter("@VoucherDate", SqlDbType.NVarChar);
                pSqlParameter[5].Direction = ParameterDirection.Input;
                pSqlParameter[5].Value = objJournalVoucherMBO.VoucherDate;

                pSqlParameter[6] = new SqlParameter("@Amount", SqlDbType.Float);
                pSqlParameter[6].Direction = ParameterDirection.Input;
                pSqlParameter[6].Value = objJournalVoucherMBO.Amount;

                pSqlParameter[7] = new SqlParameter("@TransactionType", SqlDbType.NVarChar);
                pSqlParameter[7].Direction = ParameterDirection.Input;
                pSqlParameter[7].Value = objJournalVoucherMBO.TransactionType;

                pSqlParameter[8] = new SqlParameter("@OperationType", SqlDbType.NVarChar);
                pSqlParameter[8].Direction = ParameterDirection.Input;
                pSqlParameter[8].Value = objJournalVoucherMBO.OperationType;

                pSqlParameter[9] = new SqlParameter("@ChequeNumber", SqlDbType.Int);
                pSqlParameter[9].Direction = ParameterDirection.Input;
                pSqlParameter[9].Value = objJournalVoucherMBO.ChequeNumber;

                pSqlParameter[10] = new SqlParameter("@Description", SqlDbType.NVarChar);
                pSqlParameter[10].Direction = ParameterDirection.Input;
                pSqlParameter[10].Value = objJournalVoucherMBO.Description;

                pSqlParameter[11] = new SqlParameter("@CreatedDate", SqlDbType.NVarChar);
                pSqlParameter[11].Direction = ParameterDirection.Input;
                pSqlParameter[11].Value = objJournalVoucherMBO.CreatedDate;

                pSqlParameter[12] = new SqlParameter("@CreatedBy", SqlDbType.Int);
                pSqlParameter[12].Direction = ParameterDirection.Input;
                pSqlParameter[12].Value = objJournalVoucherMBO.CreatedBy;

                pSqlParameter[13] = new SqlParameter("@IsDeleted", SqlDbType.Int);
                pSqlParameter[13].Direction = ParameterDirection.Input;
                pSqlParameter[13].Value = objJournalVoucherMBO.IsDeleted;

                pSqlParameter[14] = new SqlParameter("@LastModifideUserID", SqlDbType.Int);
                pSqlParameter[14].Direction = ParameterDirection.Input;
                pSqlParameter[14].Value = objJournalVoucherMBO.LastModifideUserID;

                pSqlParameter[15] = new SqlParameter("@LastModifideDate", SqlDbType.NVarChar);
                pSqlParameter[15].Direction = ParameterDirection.Input;
                pSqlParameter[15].Value = objJournalVoucherMBO.LastModifideDate;

                pSqlParameter[16] = new SqlParameter("@Year", SqlDbType.Int);
                pSqlParameter[16].Direction = ParameterDirection.Input;
                pSqlParameter[16].Value = objJournalVoucherMBO.Year;
