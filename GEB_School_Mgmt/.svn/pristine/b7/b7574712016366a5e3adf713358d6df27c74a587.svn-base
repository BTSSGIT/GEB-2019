<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="Vendor.aspx.cs" Inherits="GEB_School.Client.UI.Vendor" %>
                    ...
                    <div id="tabs-1" style="padding: 10px 10px 10px 10px" class="gradientBoxesWithOuterShadows">
                        ...
                        <div style="float: left; width: 100%;">
                            ...
                            <div style="float: left; margin-top: 10px; width: 50%;">
                                ...
                                <div style="float: left; width: 78%;">
                                    <asp:TextBox ID="txtAccountName" runat="server" CssClass="TextBox" Width="300px" Height="100%"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div style="float: left; width: 100%;">
