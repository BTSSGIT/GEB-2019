<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="FeeCollectionStudentWise.aspx.cs" Inherits="GEB_School.ReportUI.FeeCollectionStudentWise" %>
