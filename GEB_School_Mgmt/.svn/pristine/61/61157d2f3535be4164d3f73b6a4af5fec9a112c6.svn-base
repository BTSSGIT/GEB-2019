<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="MaterialVandorWise.aspx.cs" Inherits="GEB_School.ReportUI.MaterialVandorWise" %>
