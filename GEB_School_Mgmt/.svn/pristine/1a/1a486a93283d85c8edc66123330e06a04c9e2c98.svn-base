<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="MaterialGroup.aspx.cs" Inherits="GEB_School.Client.UI.MaterialGroup" %>
