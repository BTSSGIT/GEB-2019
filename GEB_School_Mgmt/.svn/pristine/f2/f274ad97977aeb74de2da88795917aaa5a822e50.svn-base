        ...
        public void ReadExcel(string filePath)
        {
            try
            {
                ...
                using (ExcelPackage xlPackage = new ExcelPackage(existingFile))
                {
                    ...
                    for (int i = 19; i <= 107; i++)
                    {
                        if (Blankcount == 5)
                        {
                            goto Enter;
                        }
                        if (worksheet.Cell(i, 7).Value != "" && worksheet.Cell(i, 8).Value != "" && worksheet.Cell(i, 14).Value != "" && worksheet.Cell(i, 15).Value != "" && worksheet.Cell(i, 31).Value != "" && worksheet.Cell(i, 31).Value != "" && worksheet.Cell(i, 40).Value != "" && worksheet.Cell(i, 41).Value != "" && worksheet.Cell(i, 60).Value != "" && worksheet.Cell(i, 61).Value != "" && worksheet.Cell(i, 91).Value != "")
                        {
                            rowCount++;
                        }
                        else
                ...
                Enter: ;
                    for (int j = 19; j <= rowCount; j++)
                    {
                        ...
                        {
                            dtExcelResult.Rows.Add(worksheet.Cell(j, 1).Value, worksheet.Cell(j, 2).Value, worksheet.Cell(j, 3).Value, worksheet.Cell(j, 4).Value, worksheet.Cell(j, 5).Value, worksheet.Cell(j, 6).Value, worksheet.Cell(j, 7).Value, worksheet.Cell(j, 8).Value, worksheet.Cell(j, 9).Value, worksheet.Cell(j, 10).Value, worksheet.Cell(j, 11).Value, worksheet.Cell(j, 12).Value, worksheet.Cell(j, 13).Value, worksheet.Cell(j, 14).Value, worksheet.Cell(j, 15).Value, worksheet.Cell(j, 16).Value, worksheet.Cell(j, 17).Value, worksheet.Cell(j, 18).Value, worksheet.Cell(j, 19).Value, worksheet.Cell(j, 20).Value, worksheet.Cell(j, 21).Value, worksheet.Cell(j, 22).Value, worksheet.Cell(j, 23).Value, worksheet.Cell(j, 24).Value, worksheet.Cell(j, 25).Value, worksheet.Cell(j, 26).Value, worksheet.Cell(j, 27).Value, worksheet.Cell(j, 28).Value, worksheet.Cell(j, 29).Value, worksheet.Cell(j, 30).Value, worksheet.Cell(j, 31).Value, worksheet.Cell(j, 32).Value, worksheet.Cell(j, 33).Value, worksheet.Cell(j, 34).Value, worksheet.Cell(j, 35).Value, worksheet.Cell(j, 36).Value, worksheet.Cell(j, 37).Value, worksheet.Cell(j, 38).Value, worksheet.Cell(j, 39).Value, worksheet.Cell(j, 40).Value, worksheet.Cell(j, 41).Value, worksheet.Cell(j, 42).Value, worksheet.Cell(j, 43).Value, worksheet.Cell(j, 44).Value, worksheet.Cell(j, 45).Value, worksheet.Cell(j, 46).Value, worksheet.Cell(j, 47).Value, worksheet.Cell(j, 48).Value, worksheet.Cell(j, 49).Value, worksheet.Cell(j, 50).Value, worksheet.Cell(j, 51).Value, worksheet.Cell(j, 52).Value, worksheet.Cell(j, 53).Value, worksheet.Cell(j, 54).Value, worksheet.Cell(j, 55).Value, worksheet.Cell(j, 56).Value, worksheet.Cell(j, 57).Value, worksheet.Cell(j, 58).Value, worksheet.Cell(j, 59).Value, worksheet.Cell(j, 60).Value, worksheet.Cell(j, 61).Value, worksheet.Cell(j, 62).Value, worksheet.Cell(j, 63).Value, worksheet.Cell(j, 64).Value, worksheet.Cell(j, 65).Value, worksheet.Cell(j, 66).Value, worksheet.Cell(j, 67).Value, worksheet.Cell(j, 68).Value, worksheet.Cell(j, 69).Value, worksheet.Cell(j, 70).Value, worksheet.Cell(j, 71).Value, worksheet.Cell(j, 72).Value, worksheet.Cell(j, 73).Value, worksheet.Cell(j, 74).Value, worksheet.Cell(j, 75).Value, worksheet.Cell(j, 76).Value, worksheet.Cell(j, 77).Value, worksheet.Cell(j, 78).Value, worksheet.Cell(j, 79).Value, worksheet.Cell(j, 80).Value, worksheet.Cell(j, 81).Value, worksheet.Cell(j, 82).Value, worksheet.Cell(j, 83).Value, worksheet.Cell(j, 84).Value, worksheet.Cell(j, 85).Value, worksheet.Cell(j, 86).Value, worksheet.Cell(j, 87).Value, worksheet.Cell(j, 88).Value, worksheet.Cell(j, 89).Value, worksheet.Cell(j, 90).Value, worksheet.Cell(j, 91).Value, worksheet.Cell(j, 92).Value, worksheet.Cell(j, 93).Value, worksheet.Cell(j, 94).Value, worksheet.Cell(j, 95).Value, worksheet.Cell(j, 96).Value, worksheet.Cell(j, 97).Value, worksheet.Cell(j, 98).Value, worksheet.Cell(j, 99).Value, worksheet.Cell(j, 100).Value, worksheet.Cell(j, 101).Value, worksheet.Cell(j, 102).Value);
                        }
