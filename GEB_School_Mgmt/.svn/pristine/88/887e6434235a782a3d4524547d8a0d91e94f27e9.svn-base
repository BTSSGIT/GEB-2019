...
namespace GEB_School.BL
{
	...
	public class StudentBL
	{
		...
		public ApplicationResult Student_Insert(StudentBO objStudentBO)
		{
			try
			{
                pSqlParameter = new SqlParameter[101];
                ...
                pSqlParameter[80].Value = objStudentBO.Wight;
                ...
                pSqlParameter[100] = new SqlParameter("@ISRTE", SqlDbType.VarChar);
                pSqlParameter[100].Direction = ParameterDirection.Input;
                pSqlParameter[100].Value = objStudentBO.RTE;
		...
		public ApplicationResult Student_Update(StudentBO objStudentBO, StudentTBO objStudentTBO)
		{
			try
			{
                pSqlParameter = new SqlParameter[100];
                ...
                pSqlParameter[81].Direction = ParameterDirection.Input;
                pSqlParameter[81].Value = objStudentBO.Wight;
        ...
        #region select Student Details by STD/Class wise
        public ApplicationResult Student_Select_byStudentClass(string ddlStudentClass, int Paratmeter = 2 )
        {
            try
            {
                pSqlParameter = new SqlParameter[2];

                pSqlParameter[0] = new SqlParameter("@value", SqlDbType.VarChar);
                pSqlParameter[0].Direction = ParameterDirection.Input;
                pSqlParameter[0].Value = ddlStudentClass;

                pSqlParameter[0] = new SqlParameter("@parameter", SqlDbType.VarChar);
                pSqlParameter[0].Direction = ParameterDirection.Input;
                pSqlParameter[0].Value = ddlStudentClass;
        ...
        /// <returns></returns>
        public ApplicationResult Student_Search_StudentName(string strStudentName, int strSearchID, int intEmployeeRoleID, int intStudentMID)
        {
            try
            {
                pSqlParameter = new SqlParameter[4];
        ...
        /// <param name="intStudentMID"></param>
        /// <returns></returns>
        public ApplicationResult Student_ForAutocomplete(string strSearch, int intSearchType, int intSchoolMID)
        {
            try
            {
                pSqlParameter = new SqlParameter[3];
