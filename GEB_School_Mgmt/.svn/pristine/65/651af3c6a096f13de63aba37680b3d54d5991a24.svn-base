<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="RptDayBook.aspx.cs" Inherits="GEB_School.Accounting.RptDayBook" %>
