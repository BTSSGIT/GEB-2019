<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YearWiseFeesCollectionReport.aspx.cs" MasterPageFile="~/Master/SchoolMain.Master" Inherits="GEB_School.ReportUI.CompactReport" %>
