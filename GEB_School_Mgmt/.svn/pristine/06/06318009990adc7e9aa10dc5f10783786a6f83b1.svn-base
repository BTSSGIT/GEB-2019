	...
	public class DesignationBL 
	{
        ...
        public ApplicationResult Designation_Insert(DesignationBO objDesignationBO)
        {
            try
            {
				...
				pSqlParameter[3].Direction = ParameterDirection.Input;
          		pSqlParameter[3].Value = objDesignationBO.CreatedUserID;
 
				pSqlParameter[4] = new SqlParameter("@CreatedDate",SqlDbType.VarChar);
				pSqlParameter[4].Direction = ParameterDirection.Input;
          		pSqlParameter[4].Value = objDesignationBO.CreatedDate;
        ...
        public ApplicationResult Designation_Update(DesignationBO objDesignationBO)
        {
            try
            {
				...
				pSqlParameter[4].Direction = ParameterDirection.Input;
          		pSqlParameter[4].Value = objDesignationBO.LastModifiedUserID;
 
				pSqlParameter[5] = new SqlParameter("@LastModifiedDate",SqlDbType.VarChar);
				pSqlParameter[5].Direction = ParameterDirection.Input;
          		pSqlParameter[5].Value = objDesignationBO.LastModifiedDate;
