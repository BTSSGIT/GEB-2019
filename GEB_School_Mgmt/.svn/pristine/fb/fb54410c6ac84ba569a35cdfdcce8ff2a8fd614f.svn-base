<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="DivWise.aspx.cs" Inherits="GEB_School.RTE.DivWise" %>
                                ...
                                <div style="width: 100%; float: left;" class="label">
                                        <div style="padding: 10px;">
                                            <div style="float: left; width: 15%;">
                                                Student Div :<span style="color: red">*</span>
                                            </div>
                                            <div style="float: left; width: 65%;">
                                                <asp:DropDownList ID="txtDiv" runat="server" CssClass="validate[required] TextBox mytext" Width="50%" Height="100%">
                                                ...
                                                <asp:ListItem Value="4">Higher Secondary</asp:ListItem>
                                                </asp:DropDownList>
