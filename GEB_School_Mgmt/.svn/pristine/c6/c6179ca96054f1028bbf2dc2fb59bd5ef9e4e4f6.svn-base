<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="ExamResultReport.aspx.cs" Inherits="GEB_School.Result.ExamResult" %>
