<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="SchoolPurchase.aspx.cs" Inherits="GEB_School.Client.UI.SchoolPurchase" %>
