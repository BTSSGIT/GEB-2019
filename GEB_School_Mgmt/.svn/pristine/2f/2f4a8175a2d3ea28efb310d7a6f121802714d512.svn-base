...
namespace GEB_School.Bl
{
	...
	public class LeaveBl 
	{
        ...
        /// Modified By :
        /// </summary>
        public ApplicationResult Leave_SelectAll_ForApply()
        {
            try
            {
        ...
        /// Modified By :
        /// </summary>
        public ApplicationResult Leave_Select_ForPayrollBalance(int intEmployeeMID, string strMonth)
        {
            try
            {
        ...
        /// Modified By :
        /// </summary>
        public ApplicationResult Leave_Select_ForPayrollLeave(int intEmployeeMID, string strMonth)
        {
            try
            {
                pSqlParameter = new SqlParameter[2];
