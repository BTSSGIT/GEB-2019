<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/SchoolMain.Master" CodeBehind="ExamConfigViewList.aspx.cs" Inherits="GEB_School.Result.ExamConfigViewList" %>
