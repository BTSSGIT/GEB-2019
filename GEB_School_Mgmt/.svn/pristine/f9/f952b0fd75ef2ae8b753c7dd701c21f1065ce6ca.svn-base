<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Class_Template.aspx.cs" Inherits="GEB_School.Client.UI.Class_Template" %>
