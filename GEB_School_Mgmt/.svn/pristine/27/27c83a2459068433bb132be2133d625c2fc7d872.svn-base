<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="SchoolStudentCategoryWise.aspx.cs" Inherits="GEB_School.ReportUI.SchoolStudentCategoryWise" %>
