<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="MaterialStock.aspx.cs" Inherits="GEB_School.ReportUI.MaterialStock" %>
