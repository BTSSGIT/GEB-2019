<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptBalanceSheet.aspx.cs"  MasterPageFile="~/Master/TrustMain.Master" Inherits="GEB_School.Accounting.RptBalanceSheet" %>
