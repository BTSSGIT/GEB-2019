    ...
    public partial class SchoolEmployee : System.Web.UI.Page
    {
        ...
        protected void btnAddFamily_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objEmpFamilyBO.Organisation = txtFOccupation.Text;
                ...
                if (e.CommandName.ToString() == "Edit1")
                {
                    ...
                    if (objResultsEdit != null)
                    {
                        if (objResultsEdit.resultDT.Rows.Count > 0)
                        {
                            ...
                            txtEsicNo.Text = objResultsEdit.resultDT.Rows[0][EmployeeMBO.EMPLOYEEM_NATIONALITYGUJ].ToString();
                            ...
                            if (objResultsEdit.resultDT.Rows[0][EmployeeMBO.EMPLOYEEM_TYPEOFAPPOINTMENT].ToString() == "Direct")
                            {
