            ...
            try
            {
                ...
                if (objNetResult != null)
                {
                    if (objNetResult.resultDT.Rows.Count > 0)
                    {
                        ...
                        //{
                        //    dtMainExpense.Rows.Add(1, "<b>Net Profit</b>", "<b style='float: right;'>" + (Math.Round(dblNetProfit, 2).ToString()) + "</b>");
                        //}
                        //else if (dblNetProfit < 0.00)
                        //{
                        //    dtMainIncome.Rows.Add(1, "<b>Net Loss</b>", "<b style='float: right;'>" + (Math.Abs(Math.Round(dblNetProfit, 2))).ToString() + "</b>");
                        //}
                        if (dblDiff > 0.00)
                        {
