<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="ContraEntry.aspx.cs" Inherits="GEB_School.Accounting.ContraEntry" %>
