<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="ApprovedLeaveReport.aspx.cs" Inherits="NavChetan_Kosamba.ReportUI.ApprovedLeaveReport" %>
<%@ Import Namespace="NavChetan_Kosamba.Common" %>
