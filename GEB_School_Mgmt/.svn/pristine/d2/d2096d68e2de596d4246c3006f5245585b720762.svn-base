<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="LeaveTemplate.aspx.cs" Inherits="GEB_School.Leave.LeaveTemplate" %>
