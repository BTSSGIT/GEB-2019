<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="JournalEntry.aspx.cs" Inherits="GEB_School.Accounting.JournalEntry" %>
