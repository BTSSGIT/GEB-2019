<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="SchoolMasterDetail.aspx.cs" Inherits="GEB_School.Client.UI.SchoolMasterDetail" %>
