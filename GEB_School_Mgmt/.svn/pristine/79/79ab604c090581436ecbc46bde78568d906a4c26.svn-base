<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="SchoolMaterial.aspx.cs" Inherits="GEB_School.Client.UI.SchoolMaterial" %>
