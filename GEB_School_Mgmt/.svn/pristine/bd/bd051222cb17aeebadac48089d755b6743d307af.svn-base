<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="MaterialPurchase.aspx.cs" Inherits="GEB_School.ReportUI.MaterialPurchase" %>
