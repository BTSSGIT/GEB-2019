<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="EmployeeCategoryWise.aspx.cs" Inherits="GEB_School.ReportUI.EmployeeCategoryWise" %>
