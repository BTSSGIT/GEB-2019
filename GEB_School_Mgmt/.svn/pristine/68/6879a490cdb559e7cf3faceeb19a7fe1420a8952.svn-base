<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="MaterialConsumption.aspx.cs" Inherits="GEB_School.ReportUI.MaterialConsumption" %>
