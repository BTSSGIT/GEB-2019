<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="ClassTemplate.aspx.cs" Inherits="NavChetan_Kosamba.Client.UI.ClassTemplate" %>
