<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="RptGeneralLedger.aspx.cs" Inherits="GEB_School.Accounting.RptGeneralLedger" %>
