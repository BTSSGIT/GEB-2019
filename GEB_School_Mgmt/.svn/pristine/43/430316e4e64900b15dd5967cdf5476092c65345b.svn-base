<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="PayItemTemplate.aspx.cs" Inherits="GEB_School.PayRoll.PayItemTemplate" %>
