<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="RoleRights.aspx.cs" Inherits="GEB_School.Client.UI.RoleRights" %>
