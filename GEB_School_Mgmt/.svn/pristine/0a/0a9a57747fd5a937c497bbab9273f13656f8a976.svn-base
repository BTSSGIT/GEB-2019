...
namespace GEB_School.BL
{
    ...
    public class PayItemBl
    {
        ...
        /// <param name=""></param>
        /// <returns></returns>
        public ApplicationResult PayItem_Select_PayItemName(int intTrustMID)
        {
            try
            {
                pSqlParameter = new SqlParameter[1];
