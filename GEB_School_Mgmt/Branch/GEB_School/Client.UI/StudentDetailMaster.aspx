<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="StudentDetailMaster.aspx.cs" Inherits="GEB_School.Client.UI.StudentDetailMaster" %>

<%@ Import Namespace="GEB_School.Common" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div id="divContent2" style="width: 80%; float: left; padding-bottom: 20px; padding-right: 10px; height: 100%;">
                ...
                <div id="divStudent" runat="server">
                    <div id="tabs" runat="server" class="style-tabs" style="width: 100%;">
                        ...
                        <div id="tabs-1" style="height: 995px; padding:5px 5px 5px 5px;" class="gradientBoxesWithOuterShadows">
                                ...
                                <div style="width: 30%; height: 190px; float: left; text-align: left;">
                                    ...
                                    <div style="width: 100%; float: left; padding-left: 20px" class="divclasswithfloat">
                                        <asp:Button runat="server" ID="btnShowModal" Text="Take Photo" OnClick="btnClickPhoto_Click"
                                            CausesValidation="false" CssClass="btn-blue-new btn-blue-medium" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div style="height: 30px; margin-top: 10px; float: left; width: 100%;">
                                <div style="text-align: left; width: 19%; float: left;" class="label">
                                    RTE: <span style="color: red">*</span> 
                                </div>
                       <div style="text-align: left; width: 81%; float: right;">
                                    <asp:RadioButtonList ID="rblRTE" runat="server" CssClass="radiobutton" Width="150px"  RepeatDirection="Horizontal">
                            ...
                            <div style="height: 235px; margin-top: 10px; float: left; width: 100%;">
                        ...
                        <div id="tabs-2" style="height: 445px; padding: 10px 10px 10px 10px;" class="gradientBoxesWithOuterShadows">
                            <div style="width: 100%">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("table[id*=rblRTE]").validationEngine('attach', { promptPosition: "bottomRight" });
            $("table[id*=rblRTE] input").addClass("validate[required]");
            $("[id*=btnNextAddress]").bind("click", function () {
                if (!$("table[id*=rblRTE]").validationEngine('validate')) {
                    return false;
                }
                return true;
            });
