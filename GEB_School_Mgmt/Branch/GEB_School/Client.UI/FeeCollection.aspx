<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="FeeCollection.aspx.cs" Inherits="GEB_School.Client.UI.FeeCollection" %>
        ...
        <div id="divContent" style="height: 100%; font-family: Verdana;">
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                                    ...
                                    <div style="width: 100%">
                                        <asp:GridView ID="gvFees" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Fee Amount In Rs.">
                                                    <ItemTemplate>
                ...
                <div id="divFeeCollectionPrint" style="width: 100%; display: none; text-align: center; padding: 0 20px 0 20px">
                    <table style="width: 100%; text-align: center; padding: 0 10px 0 10px">
                        <tr>
                            <td style="text-align: center; width: 100%;">
                                <table style="width: 100%; text-align: center; font-family: Verdana; font-size: 10px; border: solid 1px black;">
                                            ...
                                            <table style="width: 100%; border-bottom: 1px solid black">
                                                <tr>
                                                    <td colspan="4" style="text-align: center;">
                                                        ...
                                                        <b style="font-size: 13px;">Vidyut Nagar, Old Padra Road, Vadodara</b><br />
                                        ...
                                        <td colspan="4" style="text-align: center; vertical-align: top; height: 270px">
                                            <asp:GridView ID="gvReport" runat="server" BackColor="White" Width="100%" BorderColor="Black" AutoGenerateColumns="False" OnRowDataBound="gvReport_RowDataBound"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="FeesAmount(Rs.)">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Paid Fees(Rs.)">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Scholarship(Rs.)">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Currently Paid(Rs.)">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Pending Fees(Rs.)">
                                                        <ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="text-align: left; font-weight: bold" colspan="2">Authorized's Sign
                                        </td>
                                        <td style="text-align: right; font-weight: bold" colspan="2">Parent/Guardian's Sign
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left; font-weight: bold; height: 10px;" colspan="2"></td>
