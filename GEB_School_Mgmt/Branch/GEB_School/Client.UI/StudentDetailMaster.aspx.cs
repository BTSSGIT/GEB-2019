    ...
    public partial class StudentDetailMaster : PageBase
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objStudentBO.RTE = rblRTE.SelectedItem.ToString();
                ...
                objStudentBO.Wight = txtweight.Text;
                ...
                if (e.CommandName.ToString() == "Edit1")
                {
                    ...
                    if (objResults != null)
                    {
                        if (objResults.resultDT.Rows.Count > 0)
                        {
                            ...
                            if (objResults.resultDT.Rows[0][StudentBO.STUDENT_ADMITTEDYEAR].ToString() != "-Select-")
                            {
                            ...
                            if (objResults.resultDT.Rows[0][StudentBO.STUDENT_GENDERENG].ToString() == "Male")
                            {
                                rblGender.Items[0].Selected = true;
                            }
                            else if (objResults.resultDT.Rows[0][StudentBO.STUDENT_GENDERENG].ToString() == "Female")
                            {
                            ...
                            txtweight.Text = objResults.resultDT.Rows[0][StudentBO.STUDENT_WIGHT].ToString();
