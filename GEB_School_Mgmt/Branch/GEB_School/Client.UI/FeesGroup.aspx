<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="FeesGroup.aspx.cs" Inherits="GEB_School.Client.UI.FeesGroup" %>
                        ...
                        <div id="tabs-1" style="padding:5px 5px 5px 5px" class="gradientBoxesWithOuterShadows">
                            <div style="width: 100%;">
                                ...
                                <div style="width: 100%; text-align: right;padding:0 20px 0px 0px" class="divclasswithoutfloat">
                                    <asp:Button runat="server" ID="btnSaveFeesGroup" Text="Save" CssClass="btn-blue-new btn-blue-medium" OnClick="btnSaveFeesGroup_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
