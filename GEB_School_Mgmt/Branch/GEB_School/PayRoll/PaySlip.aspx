<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="PaySlip.aspx.cs" Inherits="GEB_School.PayRoll.PaySlip" %>
                                                ...
                                                <table style="width: 100%; font-size: 14px; vertical-align: top; height: 100%; border-collapse: collapse; border: 1px solid black">
                                                    <tr>
                                                        <td style="width: 20%; border: 1px solid black" align="center">
                                                            <img src="../Images/GEB LOGO school logo in english.jpg" width="100" height="100" />
                                                        </td>

                                                        <td style="width: 40%; border: 1px solid black; padding-left: 5px" colspan="3">VIDYUT BOARD VIDYALAYA<br />
                                                           Vidyut Nagar, Old Padra Road, Vadodara 
                                                    <br />
                                                           Gujarat 390020
                                    ...
                                    <ItemTemplate>
                                        <table style="width: 100%; font-size: 9px; vertical-align: top; height: 100%; border-collapse: collapse; border: 1px solid black">
                                            <tr>
                                                ...
                                                <td style="width: 40%; border: 1px solid black; font-size: 11px;padding-left: 5px" colspan="3">VIDYUT BOARD VIDYALAYA, ENGLISH AND GUJARATI MEDIUM<br />
                                                  Vidyut Nagar, Old Padra Road, Vadodara 
                                                    <br />
                                                           Gujarat 3920 020
