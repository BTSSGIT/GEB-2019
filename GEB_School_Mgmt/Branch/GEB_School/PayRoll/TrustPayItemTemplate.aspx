<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="TrustPayItemTemplate.aspx.cs" Inherits="GEB_School.PayRoll.TrustPayItemTemplate" %>
            ...
            <div id="divContent2" style="width: 80%; float: left; height: 100%;">
                ...
                <div id="tabs" runat="server">
                    <div id="tab-panel" class="style-tabs" visible="true">
                        <ul>
                            <li><a id="tabClassDetails" href="#tabs-1">Trust Pay Items </a></li>
                        </ul>
