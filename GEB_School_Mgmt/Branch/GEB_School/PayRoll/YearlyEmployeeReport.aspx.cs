...
namespace GEB_School.PayRoll
{
    public partial class YearlyEmployeeReport : PageBase
    {
        ...
        public void BindgvReport()
        {
            ...
            if (objResult != null)
            {
                ...
                if (objResult.resultDT.Rows.Count > 0)
                {
                    ...
                    btnPrintDetail.Visible = false;
                    lblTrustName.Text = "VIDYUT BOARD VIDYALAYA, ENGLISH AND GUJARATI MEDIUM,Vadodara";
        ...
        protected void btnPrintDetail_Click(object sender, EventArgs e)
        {
            ...
            lblTrust.Text = "VIDYUT BOARD VIDYALAYA, ENGLISH AND GUJARATI MEDIUM,Vadodara.";
