...
{
    public partial class YearWise : System.Web.UI.Page
    {
        public void PanelVisibilityMode1(bool Search, bool Grid)
        {
            //divTitle.Visible = Search;
           // ddlYear.Visible = Grid;
        }
        private static ILog logger = LogManager.GetLogger(typeof(YearWise));
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            StudentBL objStudentBL = new StudentBL();
            ApplicationResult objResult = new ApplicationResult();
            //objResult = objStudentBL.Student_Select_ClassDivisionWise(Convert.ToInt32(ddlYear.SelectedValue), 0, "0", Convert.ToInt32(Session[ApplicationSession.SCHOOLID]));
            //search by year

            if (objResult != null)
            {
                //ddlYear.DataSource = objResult.resultDT;
                //ddlYear.DataBind();
            }
