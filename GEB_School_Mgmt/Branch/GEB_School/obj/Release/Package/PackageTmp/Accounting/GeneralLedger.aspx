<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="GeneralLedger.aspx.cs" Inherits="GEB_School.Accounting.GeneralLedger" %>
			...
			<div id="divContent2" style="width: 80%; float: left; height: 100%;">
				...
				<div id="divGrid" runat="server" style="text-align: center; padding-top: 10px; padding-bottom: 10px; padding-right:10px; width: 100%;">
					...
					<asp:GridView ID="gvGeneralLedger" runat="server" AutoGenerateColumns="False"
						...
						Font-Names="verdana" Font-Size="12px" Width="100%" BackColor="White" OnRowCommand="gvGeneralLedger_RowCommand" OnRowEditing="gvGeneralLedger_RowEditing" OnPreRender="gvGeneralLedger_PreRender" >
