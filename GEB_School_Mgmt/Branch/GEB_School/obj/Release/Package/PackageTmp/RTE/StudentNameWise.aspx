<%@ Page Title="" Language="C#" MasterPageFile="~/Master/SchoolMain.Master" AutoEventWireup="true" CodeBehind="StudentNameWise.aspx.cs" Inherits="GEB_School.RTE.StudentNameWise" %>
                                ...
                                <div style="width: 100%; float: left;" class="label">
                                        <div style="padding: 10px;">
                                            ...
                                            <div id="divStudent"style="float: left; width: 65%;">
                                                <asp:TextBox ID="txtStudentName" runat="server" CssClass="validate[required] TextBox mytext" Width="50%" Height="100%"></asp:TextBox>
