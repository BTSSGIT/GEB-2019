<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TrustMain.Master" AutoEventWireup="true" CodeBehind="PayItem.aspx.cs" Inherits="GEB_School.PayRoll.PayItem" %>
                            ...
                            <div style="width: 100%;">
                                <div style="width: 100%" class="divclasswithfloat">
                                    <div style="text-align: left; width: 20%; float: left;" class="label">
                                        PayItem :<span style="color: red">*</span>
                                    </div>
                                ...
                                <div id="divDeductionVIA" style="width: 100%" class="divclasswithfloat">
                                    <fieldset>
                                        ...
                                        <div style="width: 100%" class="divclasswithfloat">
                                            <div style="text-align: left; width: 20%; float: left;" class="label">
                                                Deducttion Type :<span style="color: red">*</span>
                                            </div>
                                            <div style="text-align: left; float: left; width: 80%;">
                                                <asp:RadioButtonList ID="rbtnDeduction" runat="server" RepeatDirection="Horizontal"
                                                    Width="500px" Height="17px" TabIndex="3" RepeatLayout="Flow">
