...
namespace GEB_School.BL
{
    ...
    public class TrustPayItemBl
    {
        ...
        /// <param name=""></param>
        /// <returns></returns>
        public ApplicationResult TrustPayItem_SelectAll_AscOrder(int intTrustMID)
        {
            try
            {
                pSqlParameter = new SqlParameter[1];
        ...
        #region Delete TrustPayItem Details by TrustPayItemID
        /// <summary>
